...
docker rmi -f ghcr.io/subspace/node:gemini-3g-2023-nov-16
docker rmi -f ghcr.io/subspace/farmer:gemini-3g-2023-nov-16
...
docker build -t ghcr.io/subspace/node:gemini-3g-2023-nov-16 -f Dockerfile-node .
docker build -t ghcr.io/subspace/farmer:gemini-3g-2023-nov-16 -f Dockerfile-farmer .
