...
sed -i 's/ghcr.io\/subspace\/node:.*/ghcr.io\/autonomys\/node:gemini-3h-2024-jul-22/g' $HOME/subspace_docker*/docker-compose.yml
sed -i 's/ghcr.io\/subspace\/farmer:.*/ghcr.io\/autonomys\/farmer:gemini-3h-2024-jul-22/g' $HOME/subspace_docker*/docker-compose.yml
