...
echo "-----------------------------------------------------------------------------"
cd $HOME
wget https://github.com/0glabs/0g-chain/archive/refs/tags/v0.3.1.alpha.1.zip
unzip 0.3.1.alpha.1.zip && rm -rf 0.3.1.alpha.1.zip
mv 0g-chain-0.3.1.alpha.1/ 0g-chain/
cd $HOME/0g-chain
make install
